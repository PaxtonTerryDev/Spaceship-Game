...
func _physics_process(_delta: float) -> void:
	...
	ship.target_rotation = direction_to_mouse.angle()
	...
	if Input.is_action_pressed("ship_stern_thrusters"):
		...
		ship.engage_thruster(Ship.ShipSide.STERN, action_strength)
	...
	if Input.is_action_pressed("ship_bow_thrusters"):
		...
		ship.engage_thruster(Ship.ShipSide.BOW, action_strength)
	...
	if Input.is_action_pressed("ship_port_thrusters"):
		...
		ship.engage_thruster(Ship.ShipSide.PORT, action_strength)
	...
	if Input.is_action_pressed("ship_starboard_thrusters"):
		...
		ship.engage_thruster(Ship.ShipSide.STARBOARD, action_strength)
